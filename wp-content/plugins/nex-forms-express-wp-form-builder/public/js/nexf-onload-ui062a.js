...
function IsSafari() {
  ...
  var is_safari = navigator.userAgent.toLowerCase().indexOf('safari/index.html') > -1;
 
  if(navigator.userAgent.toLowerCase().indexOf('chrome/index.html') >-1)
  	is_safari = false;
  if(navigator.userAgent.toLowerCase().indexOf('opera/index.html') >-1)
  	is_safari = false;
